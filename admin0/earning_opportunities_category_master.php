...
{
    $eop_category_name= $_POST['eop_category_name'] ;

    $sql="INSERT INTO earning_opportunities_category_master (eop_category_name)
    VALUES ('$eop_category_name')";
    $query=mysqli_query($conn,$sql);
    if($query){
    
        header("Location:earning_opportunities_category_master.php?msg=New record submited successfully");
...
if(isset($_POST['update']))
{
        ...
        $eop_category_id=trim($_POST['eop_category_id']);
        $eop_category_name= $_POST['eop_category_name'] ;

        $update=mysqli_query($conn,"update  earning_opportunities_category_master  set eop_category_name='$eop_category_name'where eop_category_id='$eop_category_id'");
    ...
    else
    {
        ...
        header("location:earning_opportunities_category_master.php?err=".$err);
...
<!--=========== Start Indigator Bar===============================-->
            <div class="row pt-2 text-center" style="background-color:#629dad; color:#fff; font-width:700;">
                <div class="col-lg-12">
                   <h4 style="text-transform: uppercase;">Earning Opportunities Site Category Master</h4>
                </div>
            </div>
<!--=========== End Indigator Bar===============================-->
            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Add Site Category</div>
                           ...
                           //`eop_category_id`, `eop_category_name` SELECT * FROM `earning_opportunities_category_master` WHERE 1
                                    ...
                                    ?>
                                        <form action="" method="POST" enctype="multipart/form-data" >
                                            <input type="hidden" id="eop_category_id" name="eop_category_id"  readonly="readonly" value="<?php if(isset($_REQUEST['xedit'])) {echo $eop_category_id;}?>" />    

                                            <div class="row">
                                                <div class="col-sm-4 form-group">
                                                    <label>Earning Opportunities Site Category Name <span class="text-danger">*</span></label>
                                                    <input class="form-control" type="text" name="eop_category_name" value="<?php if(isset($_REQUEST['xedit'])) {echo $eop_category_name;}?>" placeholder="Enter name" required>
                                                </div>  
