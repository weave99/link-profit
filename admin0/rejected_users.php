    ...
    //`verify_otp`, `login_date`, `login_time`, `logout_time` SELECT * FROM `users` WHERE 1
        */
        ...
        if ($conn->query($update) === TRUE) {
            ...
            $accepted ="UPDATE users SET approved='$approved', membership_status='$membership_status',  rejected='$rejected' where user_id='$user_id'";
...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Rejected Users</div>
                ...
                <div class="ibox-body">
                    <table class="table table-striped table-hover">
                        ...
                        $rejected_sql="SELECT * FROM users where rejected='1'";
                        $rejected_query=mysqli_query($conn,$rejected_sql);
                        while($rejected_details=mysqli_fetch_array($rejected_query)) 
                        { 
                        ...
                        ?>
                            ...
                            <tr>
                            <td><?php echo $rejected_details['membership_id'];?></td>
                                <td><?php echo $rejected_details['date_of_joining'];?></td>
                                <td><?php echo $rejected_details['name'];?></td>
                                <td><?php echo $rejected_details['contact_no'];?></td>
                                <td><?php echo $rejected_details['email'];?></td>
                                <td><?php echo $rejected_details['country'];?></td>
                                <td>
                                <?php
                                    if($rejected_details['rejected']==1){
                                    ?>
                                ...
                                <td>
                                    <a href="user_details.php?user_id=<?php echo $rejected_details['user_id'];?>">
                                ...
                                <td>
                                    <form action="" method="post">
                                        <input type="hidden" name="user_id" value="<?php echo $rejected_details['user_id'];?>">
                                        <button class="btn btn-success" name="request_accepted">Approved</button>
