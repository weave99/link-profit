...
-->
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_administrative_announcement.php"><div class="col-lg-3 btn" style="background-color:#629dad; color:#fff;">Administrative Announcement</div></a>
                                    </div>
                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_promosonal_announcement.php"><div class="col-lg-3  btn" style="background-color:#629dad; color:#fff;">Promosonal Announcement</div></a>
                                    </div>
                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_promosonal_announcement.php"><div class="col-lg-3  btn" style="background-color:#629dad; color:#fff;">Your Statistics</div></a>
                                    </div>
                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_promosonal_announcement.php"><div class="col-lg-3  btn" style="background-color:#629dad; color:#fff;">Your Success Stories</div></a>
                                    </div>
                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_promosonal_announcement.php"><div class="col-lg-3  btn" style="background-color:#629dad; color:#fff;">How much you Satisfied with us</div></a>
                                    </div>
                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_promosonal_announcement.php"><div class="col-lg-3  btn" style="background-color:#629dad; color:#fff;">How Can we Improve our Site</div></a>
                                    </div>

                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_promosonal_announcement.php"><div class="col-lg-3  btn" style="background-color:#629dad; color:#fff;">Give Tips To Your Fellow Members to improve Earning</div></a>
                                    </div>

                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_promosonal_announcement.php"><div class="col-lg-3  btn" style="background-color:#629dad; color:#fff;">Welcome your new member</div></a>
                                    </div>
                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_promosonal_announcement.php"><div class="col-lg-3  btn" style="background-color:#629dad; color:#fff;">Problems & Doubts</div></a>
                                    </div>
                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_promosonal_announcement.php"><div class="col-lg-3  btn" style="background-color:#629dad; color:#fff;">Feature Requsted</div></a>
                                    </div>

                                    <div class="col-lg-12 mb-5">
                                        <a  href="forum_promosonal_announcement.php"><div class="col-lg-3  btn" style="background-color:#629dad; color:#fff;">Report Bugs</div></a>
                                    </div>

                                    <h5>Non English Forum(any non english speaking can comunicate in their group)</h5>
                                </div>



                                <h5 class="text-danger">Open chat section all  design </h5>
                            </div>
                        </div>
                    </div>
                </div>
