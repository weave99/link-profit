                    ...
                    <div class="col-md-12">
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                ...
                                <div class="row">
                                    <?php include ("traning_module_header_tab.php");?>
                               </div>
                               ...
                               <div class="row mt-5">
                                    ...
                                    <div class="col-lg-3 mb-3">
                                        <iframe width="100%"  src="https://www.youtube.com/embed/bSoaesWr7qA?si=5SvnHnAVbEP1fSh7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                            <p class="text-justify"><b>All catagories of programs available in internet to earn a passive earning are included here.It may need some time to include all(please excuse us for that) Before joining in any program you can judge it's</b></p>
                                    </div>  
                                    <div class="col-lg-3 mb-3">
                                        <iframe width="100%"  src="https://www.youtube.com/embed/bSoaesWr7qA?si=5SvnHnAVbEP1fSh7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                            <p class="text-justify"><b>All catagories of programs available in internet to earn a passive earning are included here.It may need some time to include all(please excuse us for that) Before joining in any program you can judge it's</b></p>
